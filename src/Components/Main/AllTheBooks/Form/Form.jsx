    ...
    <Form validated={validated} noValidate onSubmit={handleSubmit}>
        <Row className="mb-3">
            <Form.Group as={Col} md="12" controlId="validationCustom01">
                ...
                <Form.Control required type="text" placeholder="Your Comment" defaultValue=""/>
                <Form.Control.Feedback>Looks Good</Form.Control.Feedback>
            </Form.Group>
            <Form.Group as={Col} md="12" controlId="validationCustom02">
                <Form.Label>Rating (1-5)</Form.Label>
                <Form.Control required type="number" min="1" max="5" placeholder="1 - 5" defaultValue=""/>
                <Form.Control.Feedback>Looks Good</Form.Control.Feedback>
            </Form.Group>
            <Form.Group as={Col} md="12" controlId="validationCustomUsername">
            <Form.Label>Id</Form.Label>
            <InputGroup hasValidation>
            <Form.Control type="text" placeholder="Id" aria-describedby="inputGroupPrepend" value={asin} required readOnly />
        ...
        <Form.Group className="mb-3">
            <Form.Check required label="Send you comment" feedback="You must agree before submitting." feedbackType="invalid"/>
        </Form.Group>
